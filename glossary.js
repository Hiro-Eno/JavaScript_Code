...
{target:`class`, content:`この宣言によりプロトタイプベースの継承を使って、指定された名前の新しいクラスを作成。<br>*** name [extends otherName] {'クラス本体'}<br><br>*** ClassName {<br>&emsp;constructor(name) {<br>&emsp;&emsp;this.name = name;<br>&emsp;}<br>&emsp;firstProperty = 'Type';<br>&emsp;secondProperty = 10;<br>&emsp;firstMethod() {<br>&emsp;&emsp;console.log(this.name, this.secondProperty);<br>&emsp;}<br>}`},
