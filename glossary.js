...
{target:`.filter()`, content:`配列の要素をフィルタリングするためのメソッド。テストに合格した要素だけを抽出したシャローコピーの配列を作成する。<br>array.***(callbackFn)<br>const array = [12, 5, 8, 130, 44];<br>array.***((x) => x > 10)→[12, 130, 44]`},
