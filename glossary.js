...
{target:`setTimeout()`, content:`一定時間後に指定された関数を実行するDOMメソッド。<br>***(code, delay)<br>***(() => {<br>&emsp;console.log('Delayed for 1 second.');<br>}, '1000');`},
